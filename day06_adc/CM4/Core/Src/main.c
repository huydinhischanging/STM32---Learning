...
HAL_ADCEx_Calibration_Start(&hadc2, ADC_CALIB_OFFSET, ADC_SINGLE_ENDED);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    HAL_ADC_Start(&hadc2);                          // bắt đầu đo
HAL_ADC_PollForConversion(&hadc2, 100);         // chờ đo xong
uint32_t adc_value = HAL_ADC_GetValue(&hadc2);  // lấy số 0..65535

uint32_t voltage_mv = adc_value * 3300 / 65535;    // 65535 tương ứng 3300 mV
